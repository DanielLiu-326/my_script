...
impl BinaryOp<"op_or"> for Float {
    ...
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_or").into())
    }
}

impl BinaryOp<"op_and"> for Float {
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_and").into())
    }
}

impl BinaryOp<"op_bit_or"> for Float {
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_bit_or").into())
    }
}

impl BinaryOp<"op_bit_xor"> for Float {
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_bit_xor").into())
    }
}

impl BinaryOp<"op_bit_and"> for Float{
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_bit_and").into())
    }
}
...
impl BinaryOp<"op_l_mov"> for Float{
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_l_mov").into())
    }
}

impl BinaryOp<"op_r_mov"> for Float{
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_r_mov").into())
    }
}
...
impl BinaryOp<"op_mod"> for Float{
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_mod").into())
    }
}

impl BinaryOp<"op_fact"> for Float{
    fn op_call(&self, other: &RegType) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_fact").into())
    }
}
...
impl UnaryOp<"op_bit_not"> for Float {
    fn op_call(&self) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_assign").into())
    }
}

impl UnaryOp<"op_not"> for Float{
    fn op_call(&self) -> Result<Value> {
        Result::Err(UnsupportedOp::new("op_not").into())
    }
}
